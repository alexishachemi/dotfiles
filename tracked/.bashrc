...
alias ne="emacs"
alias nv="nvim"
alias ne_config="emacs ~/.emacs"

# customization
alias prf="nano ~/.profile"
alias brc="nano ~/.bashrc"
alias sbrc="source ~/.bashrc"

# general
alias cls="clear"
alias maj="sudo apt update -y; sudo apt upgrade -y; sudo apt autoremove -y"
...
alias init_tty="sudo sh -c 'dumpkeys -k|grep -v Incr_Console|grep -v Decr_Console|grep -v Last_Console|loadkeys'; set_tty_zoom"

# Programming
alias jake="make -j$(nproc)"
alias j="jake -s"
alias m="make 1> /dev/null"
